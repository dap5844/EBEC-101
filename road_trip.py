...
def main():
    dist = float(input("Road trip fuel cost estimator:\n  How far away is your destination (miles)? ")) #Get distance to travel
    ...
    print(f"\nThe fuel cost for this trip is approximately ${cost}.") #output the cost
